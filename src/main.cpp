...
// 10パターンの動作時間（1000-3000ms）とインターバル（0-1500ms）
const int patternRotateTimes[10] = {3200, 2700, 3400, 2500, 3100, 2900, 3500, 2600, 3300, 2800};  // ms (2.5~3.5秒)
const int patternIntervals[10] = {1200, 750, 450, 1050, 150, 1350, 600, 900, 1500, 300};  // ms (0-1500ms)
